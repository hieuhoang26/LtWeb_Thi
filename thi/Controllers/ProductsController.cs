...
namespace HoangHuyHieu_211243214.Controllers
{
    ...
    {
        private readonly LtWeb_Thi_ShopContext _context;

        public ProductsController(LtWeb_Thi_ShopContext context)
        {
            _context = context;
        }
        ...
        {
            var ltWeb_Thi_ShopContext = _context.Products.Include(p => p.Category).Include(p => p.Provider);
            return View(await ltWeb_Thi_ShopContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'LtWeb_Thi_ShopContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
